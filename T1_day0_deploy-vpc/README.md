...
Desde el [portal formación](http://mcs24.forticat.net) podeis encontrar el acceso a vuestro entorno Cloud9.
...
```
git clone https://github.com/oscarcaparros/MCS24_ALUMNOS
```
...
- Se debe actualizar con los datos de cada participante para poder completar el lab
- Los datos se obtinen desde el [portal formación](http://mcs24.forticat.net) 
...
variable "tags" {
  ...
  type = map(any)
  default     = {
    Owner   = "mcs24-eu-west-1-user-1"   //update with your assigned user for access AWS console
...
- Actualizar las variables con los datos proporcionados en el [portal formación](http://mcs24.forticat.net) 
```
...
Pasar a lab 2: [T2_day0_deploy-server]
